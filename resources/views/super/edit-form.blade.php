<form class="ajax reset" action="{{route('superAdmin.update',$admin->user_id)}}" method="post" data-handler="commonResponseForModal">
    @csrf
        ...
        <div class="d-flex justify-content-between align-items-center pb-30">
            ...
            <div class="mClose">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <img src="{{ asset('public/assets/images/icon/delete.svg') }}" alt="" />
                </button>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        ...
                        <input type="text" class="primary-form-control" name="first_name" value="{{ $admin->first_name }}">
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        ...
                        <input type="text" class="primary-form-control" name="last_name" value="{{ $admin->last_name }}">
                    </div>
                </div>
            </div>
            <div class="col-12">
