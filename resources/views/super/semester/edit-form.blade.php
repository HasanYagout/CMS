<form class="ajax reset" action="{{route('superAdmin.semesters.update',$semester->id)}}" method="post" data-handler="commonResponseForModal">
    @csrf
            ...
            <div class="col-12">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        ...
                        <input type="text" class="primary-form-control" name="name" value="{{ $semester->name }}">
                    </div>
                </div>
            </div>
        </div>
