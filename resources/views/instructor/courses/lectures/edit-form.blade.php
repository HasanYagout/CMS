<form class="ajax reset" action="{{ route('instructor.courses.lectures.update', $lecture->id) }}" method="post"
    ...
    <div class="modal-body zModalTwo-body model-lg">
        ...
        <div class="row">
            <div class="col-6">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        ...
                        <input type="text" class="primary-form-control" name="title" value="{{ $lecture->title }}"
                               required>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        <label for="chapter" class="form-label">{{ __('Description') }} <span
                                class="text-danger">*</span></label>
                        <textarea name="description" class="primary-form-control summernoteOne min-h-180"
                                  id="description" placeholder="Details"
                                  spellcheck="false">{{$lecture->description}}</textarea>
