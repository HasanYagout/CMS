    ...
    <div class="modal-body zModalTwo-body model-lg">
        ...
        <div class="row">
            <div class="col-12">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        <label for="firstName" class="form-label">{{ __('Title') }} <span
            ...
            <div class="col-12">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        <label for="firstName" class="form-label">{{ __('Description') }} <span
                                class="text-danger">*</span></label>
                        <textarea name="description"
                                  class="primary-form-control summernoteOne min-h-180" id="description"
                                  placeholder="Details" spellcheck="false">{{$news->description}}</textarea>
                    </div>
                </div>
            </div>
        </div>
